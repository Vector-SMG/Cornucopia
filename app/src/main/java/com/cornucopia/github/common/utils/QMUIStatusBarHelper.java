...
public class QMUIStatusBarHelper {
  ...
  public static boolean setStatusBarLightMode(Activity activity) {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
      if (isMIUICustomStatusBarLightModeImpl() && MIUISetStatusBarLightMode(activity.getWindow(),
          true)) {
  ...
  @IntDef({
      STATUSBAR_TYPE_DEFAULT, STATUSBAR_TYPE_MIUI, STATUSBAR_TYPE_FLYME, STATUSBAR_TYPE_ANDROID6
  })
